...
OffsetDetector::OffsetCache OffsetManager::currentOffsets = OffsetDetector::FALLBACK_OFFSETS;
    ...
    PID(processID)
{
    ...
    // Initialize offset detection system for this client version
    OffsetManager::Initialize(handle, Version);
